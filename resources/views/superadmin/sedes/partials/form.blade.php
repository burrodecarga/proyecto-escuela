...
<div class="mb-1">
    ...
    <select name="school_id" class="w-full rounded-lg">
        @foreach ($schools as $school)
            <option value="{{ $school->id }}"> {{ __($title) . ' : ' . $school->name }}</option>
        @endforeach
    </select>
    ...
    <div class="col-span-1">
        <div class="mb-1">
            ...
            <div class="p-4">
                ...
                @else
                    <img id="img" class="object-cover my-2 rounded-md max-h-48" style="max-height: 190px"
                        src="{{ asset('img/schools/foto.png') }}" />
                @endif
            </div>
        ...
        <div class="mb-1">
            ...
            <div class="p-4">
                ...
                @else
                    <img id="img1" class="object-cover my-2 rounded-md max-h-48" style="max-height: 190px"
                        src="{{ asset('img/schools/school.jpg') }}" />
                @endif
            </div>
