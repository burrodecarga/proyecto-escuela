<div class="flex-grow w-full bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    ...
    @else
        <a href="#">
            <img class="object-cover w-full h-48 rounded-t-lg" src="{{ asset('img/image-1.jpg') }}" alt="" />
        </a>
    @endif
    <div class="p-5">
        <a href="#">
        ...
        <a href="#" wire:click="$set('openVideoModal',true)"
    ...
    @include('components.modales.addVideoModal')
</div>
